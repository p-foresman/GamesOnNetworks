...
db_insert_graph(graphmodel::GraphModel) = db_insert_graph(SETTINGS.database, graphmodel)
...
function db_construct_id_tuple(model::SimModel)
    ...
    db_id_tuple::DatabaseIdTuple = (
                    ...
                    sim_params_id = db_insert_simparams(db_info, simparams(model), SETTINGS.use_seed),
...
#                     db_insert_graph(SETTINGS.database, graphmodel)
#                     db_insert_sim_params(SETTINGS.database, simparams, SETTINGS.use_seed)
#                     db_insert_starting_condition(SETTINGS.database, startingcondition)
#                     db_insert_stopping_condition(SETTINGS.database, stoppingcondition)
#                     end
#                 end
#             end
#         end
