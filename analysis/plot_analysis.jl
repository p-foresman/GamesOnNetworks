...
legend_labels = ["Complete", "Erdos-Renyi λ=1", "Erdos-Renyi λ=5", "Small World", "SF", "SF", "SF", "SBM"]
colors = [palette(:default)[11], palette(:default)[2], palette(:default)[2], palette(:default)[12], palette(:default)[9], palette(:default)[9], palette(:default)[9], palette(:default)[14]]
error_styles = [(:dash, nothing), (:solid, nothing)]
test_plot_2 = numberAgentsTransitionTimeLinePlot("./sqlite/SlurmSimulationSaves.sqlite"; game_id=1, number_agents_list=[10, 20, 30, 40, 50, 60, 70], memory_length=10, errors=[0.1], graph_ids=[1, 2, 3, 4, 5, 6, 7, 8], sample_size=20, conf_intervals=true, legend_labels=legend_labels, colors=colors, error_styles=error_styles)
