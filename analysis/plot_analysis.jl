...
test_plot_2 = numberAgentsTransitionTimeLinePlot("./sqlite/SimulationSaves.sqlite"; game_id=1, number_agents_list=[10, 20, 30, 40], memory_length=10, errors=[0.1], graph_ids=[1, 2], sample_size=20, conf_level=0.95)

test_plot_3 = memoryLengthTransitionTimeLinePlot("./sqlite/SimulationSaves.sqlite"; game_id=1, number_agents=10, memory_length_list=[10, 13, 16, 19], errors=[0.1], graph_ids=[1, 2, 3, 4], sample_size=20, conf_level=0.95)
