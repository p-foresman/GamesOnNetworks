...
# const sim_group_id = insertSimGroup(db_filepath, "Population Iteration").insert_row_id
...
periods = simulateABM(game, sim_params_list[1], abm_params, starting_condition, stopping_condition) # db_filepath=db_filepath, db_sim_group_id=1
