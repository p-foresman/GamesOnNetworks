...
const sim_group_id_4 = insertSimGroup(db_filepath, "Memory Length Iteration, N=50").insert_row_id
...
simulationIterator(game, sim_params_list, graph_params, starting_condition, stopping_condition; run_count=1, db_filepath=db_filepath, db_sim_group_id=sim_group_id) # db_filepath=db_filepath, db_sim_group_id=1
