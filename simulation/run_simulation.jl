...
const db_filepath = "./sqlite/test15.sqlite"
...
## 5: run simulation
simulationIterator(game, sim_params_list, graph_params_list; run_count=1, db_filepath=db_filepath, db_sim_group_id=sim_group_id, db_store_period=1000) # db_filepath=db_filepath, db_sim_group_id=1
