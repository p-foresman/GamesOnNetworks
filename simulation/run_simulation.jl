...
const sim_group_id = insertSimGroup(db_filepath, "parameter iteration for transition time with equity_behavioral stopping condition").insert_row_id
...
## 5: run simulation
simulationIterator(game, sim_params_list, graph_params_list; run_count=20, stopping_condition=:equity_behavioral, db_filepath=db_filepath, db_sim_group_id=sim_group_id) # db_filepath=db_filepath, db_sim_group_id=1
